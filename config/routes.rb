ActionController::Routing::Routes.draw do |map|
  ...
  map.resume '/Grace_Chow_Resume_2010-11-24.pdf', :controller => 'not_a_controller', :path => '/Grace_Chow_Resume_2010-11-24.pdf'
  ...
  map.root :controller => "galleries", :action => "show"
